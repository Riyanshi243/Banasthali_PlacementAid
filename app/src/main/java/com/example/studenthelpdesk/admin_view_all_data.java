                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                    ...
                                    doc2.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            ...
                                            srno.setMovementMethod(new ScrollingMovementMethod());
                                            email =(TextView) v.findViewById(R.id.email);
                                            email.setMovementMethod(new ScrollingMovementMethod());
                                            name =(TextView) v.findViewById(R.id.name);
                                            name.setMovementMethod(new ScrollingMovementMethod());
                                            gender=(TextView) v.findViewById(R.id.gender);
                                            gender.setMovementMethod(new ScrollingMovementMethod());
                                            phoneno=(TextView) v.findViewById(R.id.phoneno);
                                            phoneno.setMovementMethod(new ScrollingMovementMethod());
                                            DOB=(TextView) v.findViewById(R.id.DOB);
                                            DOB.setMovementMethod(new ScrollingMovementMethod());
                                            rollno=(TextView) v.findViewById(R.id.rollno);
                                            rollno.setMovementMethod(new ScrollingMovementMethod());
                                            enrollment=(TextView) v.findViewById(R.id.enrollment);
                                            enrollment.setMovementMethod(new ScrollingMovementMethod());
                                            ...
                                            branch.setMovementMethod(new ScrollingMovementMethod());
                                            sem=(TextView) v.findViewById(R.id.sem);
                                            sem.setMovementMethod(new ScrollingMovementMethod());
                                            fname=(TextView) v.findViewById(R.id.fname);
                                            fname.setMovementMethod(new ScrollingMovementMethod());
                                            mname=(TextView) v.findViewById(R.id.mname);
                                            mname.setMovementMethod(new ScrollingMovementMethod());
                                            adhar=(TextView) v.findViewById(R.id.adhar);
                                            adhar.setMovementMethod(new ScrollingMovementMethod());
                                            pan=(TextView) v.findViewById(R.id.pan);
                                            pan.setMovementMethod(new ScrollingMovementMethod());
                                            ten=(TextView) v.findViewById(R.id.ten);
                                            ten.setMovementMethod(new ScrollingMovementMethod());
                                            twelve=(TextView) v.findViewById(R.id.twelve);
                                            twelve.setMovementMethod(new ScrollingMovementMethod());
                                            CGPA=(TextView) v.findViewById(R.id.CGPA);
                                            CGPA.setMovementMethod(new ScrollingMovementMethod());
